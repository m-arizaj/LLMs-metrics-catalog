...
## Key References
* Salimans, T., Goodfellow, I., Zaremba, W., Cheung, V., Radford, A., & Chen, X. (2016). *Improved techniques for training GANs*. In *Advances in Neural Information Processing Systems, volume 29*.
* Stein, G., Cresswell, J. C., Hosseinzadeh, R., et al. (2023). *Exposing flaws of generative model evaluation metrics and their unfair treatment of diffusion models*. In *37th Conference on Neural Information Processing Systems (NeurIPS 2023)*. 
* (Excel Data: Paper 67)