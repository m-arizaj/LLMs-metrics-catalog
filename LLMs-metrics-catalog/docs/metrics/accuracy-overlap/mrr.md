...
## Variants
- RR@k (Reciprocal Rank @ k): Measures reciprocal rank but only within the top *k* retrieved results.  
- Mean Reciprocal Rank (standard): Averages reciprocal ranks across all queries.  
...
[https://arxiv.org/abs/2306.07908](https://arxiv.org/abs/2306.07908)
